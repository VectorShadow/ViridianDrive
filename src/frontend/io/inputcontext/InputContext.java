...
public abstract class InputContext {
     ...
     */
    protected int toInt(int keyCode) {
        switch (keyCode) {
            case VK_0: return 0;
            case VK_1: return 1;
            case VK_2: return 2;
    ...
    /**
     * Convert a keyboard input to a typed character.
     */
    protected char toChar(int keyCode, int keyMod) {
        switch (keyCode) {
            case VK_A:
    ...
    /**
     * Helper method for toChar().
     */
    private static boolean andEquals(int value, int mask) {
